                        ...
                        <select id="route_selector"
                            ...
                            @foreach ($routes ?? [] as $route)
                                <option value="{{ $route->id }}" data-origin="{{ $route->origin_city }}" data-destination="{{ $route->destination_city }}"
                                    {{ (old('departure_city', $schedule->departure_city) == $route->origin_city && old('arrival_city', $schedule->arrival_city) == $route->destination_city) ? 'selected' : '' }}>
                                    {{ $route->origin_city }} → {{ $route->destination_city }}
                                </option>
                            @endforeach
                        </select>
                        <input type="hidden" name="departure_city" id="departure_city" value="{{ old('departure_city', $schedule->departure_city) }}">
                        <input type="hidden" name="arrival_city" id="arrival_city" value="{{ old('arrival_city', $schedule->arrival_city) }}">
