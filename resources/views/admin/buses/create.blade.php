    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-800">Tambah Bus Baru</h2>
                <p class="mt-1 text-sm text-gray-600">
                    Isi formulir di bawah untuk menambahkan armada bus baru
                </p>
            </div>
            ...
            <form action="{{ route('admin.buses.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="bus_name" id="bus_name" value="{{ old('bus_name') }}"
                    ...
                    <div>
                        ...
                        <select name="bus_type" id="bus_type"
                            ...
                            <option value="Regular" {{ old('bus_type') == 'Regular' ? 'selected' : '' }}>Reguler</option>
                            <option value="Executive" {{ old('bus_type') == 'Executive' ? 'selected' : '' }}>Eksekutif
                            </option>
                            <option value="VIP" {{ old('bus_type') == 'VIP' ? 'selected' : '' }}>VIP</option>
                            <option value="Super" {{ old('bus_type') == 'Super' ? 'selected' : '' }}>Super</option>
                        </select>
                        @error('bus_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
